...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="../greet/css/list.css">
                        ...
                        <div class="list_count">
                            ...
                            <div id="list_count2">
                                <div class="layout_change">
                                    <a href="./list.php?scale=<?=$scale?>&page=<?=$page?>&liststyle=list" class="layout_change_1"></a>
                                    <a href="./list.php?scale=<?=$scale?>&page=<?=$page?>&liststyle=box" class="layout_change_2"></a>
                                </div>   
...
?>
                            ...
                            <div id="list_item">
                                ...
                                <div id="list_item2">
                                    <a href="view.php?table=<?=$table?>&num=<?=$item_num?>&page=<?=$page?>&liststyle=<?=$liststyle?>"><?= $item_subject ?></a>
                                    <?  if ($num_ripple)    echo " [$num_ripple]";  ?>
                                </div>
                                <div class="layout_inner">
                                    <div id="list_item3"><?= $item_nick ?></div>
                                    <div id="list_item4"><i class="fa-regular fa-calendar-days"></i> <?= $item_date ?></div>
                                    <div id="list_item5"><i class="fa-solid fa-eye"></i> <?= $item_hit ?></div>
                                </div>
                            </div>
                            <?
		$number--;
