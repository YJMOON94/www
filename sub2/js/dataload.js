...
$.ajax({
    ...
    success:function(data){
        ...
        shipimg += '<img src="./images/content1/ship0'+(i+1)+'.jpg" alt="'+useData[i].imgAlt+'">'
        

        $('.conMid .blueBox ul:eq(0)').html(shiptitle);
        ...
        shipimg2 += '<img src="./images/content1/business0'+(j+1)+'.jpg" alt="'+useData2[j].imgAlt+'">'
        

        $('.conBtm .blueBox ul:eq(0)').html(shiptitle2);
